...
export const qrService = {
     ...
     */
    async scanQRCode(workerId, qrCodeValue, scanLocation) {
        ...
        const { data: distanceData, error: distanceError } = await supabase.rpc('get_distance_sphere', {
     ...
     */
    async createQRCode(userId, location) {
        // 1. Check for existing points within 15m radius
        const { data: existingPoints, error: searchError } = await supabase.rpc('get_nearby_qr_codes', {
